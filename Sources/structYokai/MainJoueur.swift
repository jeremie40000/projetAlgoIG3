...
public struct MainJoueur : MainJoueurProtocol{
    ...
    public mutating func ModifMainJoueur(P: Piece) throws -> MainJoueur {
        ...
        var index = 0
        for i in 0..<tab.count {
            if((tab[i].NomPiece() == P.NomPiece()) || ((P.NomPiece()=="SamouraiKodama1" || P.NomPiece()=="SamouraiKodama2") && (tab[i].NomPiece()=="Kodama1" || tab[i].NomPiece()=="Kodama2")) || ((P.NomPiece()=="Kodama1" || P.NomPiece()=="Kodama2") && (tab[i].NomPiece()=="SamouraiKodama1" || tab[i].NomPiece()=="SamouraiKodama2"))){
                presente = true
                index = i
            }
        }
